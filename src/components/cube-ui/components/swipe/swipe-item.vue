<template>
  <div ref="swipeItem" @transitionend="onTransitionEnd" @touchstart="onTouchStart" @touchmove="onTouchMove" @touchend="onTouchEnd" class="cube-swipe-item">
    <slot>
    ...
    <ul class="cube-swipe-btns">
      <li ref="btns" v-for="(btn,index) in btns" :key="index" class="cube-swipe-btn" :style="genBtnStyl(btn)" @click.prevent="clickBtn(btn)">
