<template>
  <div class="cube-input" :class="{'cube-input_active': isFocus}">
    ...
    <input class="cube-input-field" ref="input" v-model="inputValue" v-bind="$props" :type="_type" :disabled="disabled" :readonly="readonly" :autocomplete="autocomplete" :autofocus="autofocus" @focus="handleFocus" @blur="handleBlur" @change="changeHander">
